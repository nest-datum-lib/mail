	...
	async send() {
		...
		try {
			...
			await Bluebird.each([{
				...
				id: 'mail-setting-transport-provider',
				...
				id: 'mail-setting-transport-host',
				name: 'Service host',
				...
				id: 'mail-setting-transport-port',
				name: 'Service port',
				...
				id: 'mail-setting-cache-namespace',
				...
				id: 'mail-setting-cache-password',
				name: 'Cache password',
