...
export class TemplateOptionController {
	...
	@MessagePattern({ cmd: 'templateOption.drop' })
	async drop(payload) {
		try {
	...
	@MessagePattern({ cmd: 'templateOption.dropMany' })
	...
	@MessagePattern({ cmd: 'templateOption.create' })
	...
	@MessagePattern({ cmd: 'templateOption.update' })
