...
import { LetterOptionHttpController } from './letter-option-http.controller';
...
@Module({
	controllers: [ LetterOptionHttpController ],
	imports: [
...
export class LetterOptionHttpModule implements NestModule {
